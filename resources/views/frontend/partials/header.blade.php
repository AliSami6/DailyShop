            ...
            <div class="aa-header-top-area">
                ...
                <div class="aa-language">
                  <div class="dropdown">
                    <a class="btn dropdown-toggle" href="#" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                      <img src="frontend/img/flag/english.jpg" alt="english flag">ENGLISH
                      <span class="caret"></span>
                    </a>
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                      <li><a href="#"><img src="frontend/img/flag/french.jpg" alt="">FRENCH</a></li>
                      <li><a href="#"><img src="frontend/img/flag/english.jpg" alt="">ENGLISH</a></li>
                    </ul>
                  </div>
                </div>
                <!-- / language -->
              ...
              <div class="aa-header-top-right">
                <ul class="aa-head-top-nav-right">
                  ...
                  <li class="hidden-xs"><a href="{{url('/carts')}}">My Cart</a></li>
                  <li class="hidden-xs"><a href="{{url('/checkouts')}}">Checkout</a></li>
            ...
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-cartbox">
                ...
                <div class="aa-cartbox-summary">
                  <ul>
                    <li>
                      <a class="aa-cartbox-img" href="#"><img src="frontend/img/woman-small-2.jpg" alt="img"></a>
                    ...
                    <li>
                      <a class="aa-cartbox-img" href="#"><img src="frontend/img/woman-small-1.jpg" alt="img"></a>
                      <div class="aa-cartbox-info">
                        <h4><a href="#">Product Name</a></h4>
                        <p>1 x $250</p>
                      </div>
